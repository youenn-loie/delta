...
class Bars():
    ...
    def __init__(self, application=None):
        ...
        fig_blue_1 = px.histogram(data_frame=mean_by_bar_number, x='Revenu fiscal de référence par foyer fiscal', y='Nombre de bars')
...
"""),
                ...
                dcc.Markdown("""On voit très clairement ici que les bars se concentrent principalement dans la capitales et sur les littoraux"""),
                html.Br(),
                html.Br(),
                html.Div(
                ...
                * Les villes sont quant à elles beaucoup plus marquées car la concentration de bars y est plus importante et les revenus fiscaux plus élevés"""),
                ...
                html.Br(),
                dcc.Markdown("""Sur le graphe 3 on voit que globalement la plus part des villes/codes postaux possèdent moins de 20 bars. On voit également que dans les villes à fort et faible revenus fiscaux, dans les extremums, la quantité de bars n'excède pas la centaine de bars."""),
                dcc.Markdown("""Nous voyons sur ce premier graphe qu'un grand nombre de bars se trouve dans les endroits avec un revenus fiscal de référence assez faible."""),
                dcc.Markdown("""Nous voyons sur ce dernier graphe que le nombre de bars est assez faible dans les extremums et que la plus part des endroits avec beaucoup de bars se trouvent dans les endroits avec un revenu fiscal de référence compris entre 20 et 40 ce qui appuie les résultats du barplot."""),
                html.Br(),
                html.Br(),
